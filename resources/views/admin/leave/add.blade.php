      ...
      <div class="col-lg-6">
        <div class="panel">
          <div class="panel-body">
            {{ Form::open(['url' => route('admin.leave.store'), 'autocomplete' => 'off']) }}
              ...
              <div class="form-group">
                ...
                {{ Form::select('status', array('approved' => 'Approved', 'pending' => 'Pending', 'rejected' => 'Rejected'), null, array('class' => 'form-control selectpicker')) }}
              </div>
              ...
              <div class="row m-t-20">
                <div class="col-xs-12">
                  <a href="{{ route('admin.leave.index') }}" class="btn btn-default"><i class="fa fa-chevron-left"></i> Cancel</a>
